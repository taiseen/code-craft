import HeaderProfileBtn from "@/app/(root)/_components/header/HeaderProfileBtn";
            ...
            <SignedOut>
              <Link
                ...
                className="flex items-center gap-2 px-4 py-1.5 rounded-lg border border-amber-500/20
                 hover:border-amber-500/40 bg-gradient-to-r from-amber-500/10 to-orange-500/10 hover:from-amber-500/20 hover:to-orange-500/20 transition-all duration-300"
              >
